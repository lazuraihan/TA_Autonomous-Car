...
public:
    ...
    static std::vector<float> toQuaternionE(const Eigen::Matrix3f &eigMat);
    ...
    static Sophus::SE3<float> ToSophusSE3f(const cv::Mat& cvMat);
    static Sophus::Sim3f toSophus(const g2o::Sim3& S);

    static Eigen::Matrix<float,4,4> cvMatToEigen(const cv::Mat& mat);
