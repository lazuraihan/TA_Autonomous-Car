...
LoopClosing::LoopClosing(Atlas *pAtlas, KeyFrameDatabase *pDB, ORBVocabulary *pVoc, const bool bFixScale, const bool bActiveLC):
    ...
    mbLoopDetected(false), mbMergeDetected(false), mnLoopNumNotFound(0), mnMergeNumNotFound(0), loop_detected(false), mbActiveLC(bActiveLC)
{
...
void LoopClosing::CorrectLoop()
{
    ...
    loop_detected = mpTracker->loop_detected = true; //modified for grid map
